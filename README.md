# Smart Garden System Penyiraman Tanaman Otomatis
...
3,Soil Moisture Sensor,Analog A0,Mendeteksi tingkat kelembapan tanah
4,Motor Servo (SG90),Digital 7 (PWM),Simulasi katup kran / pompa air
5,LED Red,Digital 8,Indikator visual saat penyiraman aktif
6,Buzzer,Digital 9,Alarm suara saat kondisi tanah kering
